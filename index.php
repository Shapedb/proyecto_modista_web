...
<body id="body">
      ...
      <main>
        ...
        <div class="container marketing">
          ...
          <div class="row">
            <div class="col-lg-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bd-placeholder-img" viewBox="0 0 16 16">
            ...
            <div class="col-lg-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
            ...
            <div class="col-lg-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" fill="currentColor" class="bi bi-map" viewBox="0 0 16 16">
          ...
          <div class="row featurette">
            <div class="col-md-7">
              <h2 class="featurette-heading fw-normal lh-1">Hacemos realidad lo que usted <span class="text-muted">imagine.</span></h2>
              <p class="lead">Los diseños son creeados por nuestros propios empleados para ajustarnos a los detalles y peticiones de usted.</p>
            </div>
            <div class="col-md-5">
             <img src="img/index/sketch.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false">
