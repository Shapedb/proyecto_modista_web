...
<body id="body" class="body">
    ...
    <div>
        ...
        <div class="row mb-1">
            <h5 class="col-lg-1 m-3"><?php echo $mostrar1['MEDI'] ?>:</h5>
            <p class="col-lg-8 m-3"><?php echo $mostrar1['UNI'] ?></p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <form action="../php/eliminar/pedido.php" method="POST">
                    <input type="hidden" value="<?php echo $op?>" name="idP"readonly>
